...
I am a Computer Science student with experience programming in Python, Java, and C++. I have also worked with React, JavaScript, and web development. I am interested in artificial intelligence, machine learning, and software development, and I want to improve my ability to work with existing codebases, debug problems, and contribute to open-source projects.

For my first contribution, I prefer issues involving Python, JavaScript, or beginner-accessible application code. I am comfortable learning unfamiliar tools and libraries when the issue provides enough information to understand the expected behavior. I would prefer to avoid issues requiring major architectural changes or extensive modifications to unfamiliar infrastructure.
